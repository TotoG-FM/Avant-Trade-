...
# Désactiver XLA pour éviter les incompatibilités
    ...
    def update_positions(self, symbol, quantity):
        try:
            ...
            if cost > self.capital:
                logger.warning(
                    f"Pas assez de capital pour acheter {symbol} : coût={cost:.2f} > capital={self.capital:.2f}")
                return False
